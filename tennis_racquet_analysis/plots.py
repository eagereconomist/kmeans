...
def hist(
    ...
    progress_bar = tqdm(total=2, desc="Histogram Steps", ncols=80)
...
def scatter(
    ...
    logger.info(
        f"Scatter plot: {x_axis} and {y_axis} from {file_label} in directory '{dir_label}'."
    )
    progress_bar_2 = tqdm(total=2, desc="Scatter Plot Steps", ncols=80)
